...
import './common.scss'
import airplane from '../../assets/Icons/airoplane.svg'
    ...
    <header>
      <nav >
        <Row className='d-flex justify-content-between align-items-center'>
          ...
          <Col lg="4" md="4" sm="10" xs="8" className='d-flex justify-content-center align-items-center'>
          ...
          <Col sm="2" xs="4" className='menu-icon'>
